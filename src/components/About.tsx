...
export default function About() {
  ...
  return (
    <section id="sobre" className="py-28 px-6 relative overflow-hidden bg-slate-50/40 border-y border-slate-200/50">
      {/* Decorative vertical lines and dots */}
      <div className="absolute top-0 left-[20%] w-[1px] h-full bg-slate-200/30 pointer-events-none hidden lg:block"></div>
        ...
        <div className="lg:col-span-5 relative group">
          ...
          >
            ...
            <div className="relative border border-slate-200/50 rounded-[2rem] overflow-hidden bg-white p-4 transition-fluid hover:scale-101 shadow-md">
              ...
              <div className="absolute bottom-8 left-8 right-8 glassmorphism p-5 rounded-2xl border border-primary/20 shadow-lg transition-fluid hover:border-primary/40">
        ...
        <div className="lg:col-span-7 text-left">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold font-display text-slate-900 mb-6 leading-[1.15] tracking-tight">
              A contabilidade que seu negócio precisa para crescer sem <span className="font-serif italic font-normal text-primary text-glow font-light">limites</span>.
            </h2>
            ...
            {/* Core Values Grid in Light Mode */}
            <div className="grid md:grid-cols-3 gap-6">
              {coreValues.map((val, i) => (
                <div 
                  key={i} 
                  className="p-6 bg-white border border-slate-200/50 rounded-2xl hover:border-primary/30 hover:bg-[#FCFAF6] hover:-translate-y-1 transition-fluid shadow-sm"
                >
